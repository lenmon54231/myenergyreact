    ...
    try {
      if (!this.hide) {
        if (this.sliceWidth && this.sliceHeight) {
          canvas.drawImage(isImg ? img : _this.loader.getImg(src), this.sliceX, this.sliceY, this.sliceWidth, this.sliceHeight, this.scaled_x, this.scaled_y, this.scaled_width, this.scaled_height);
        } else {
          canvas.drawImage(isImg ? img : _this.loader.getImg(src), this.scaled_x, this.scaled_y, this.scaled_width, this.scaled_height);
        }
      }
    } catch (error) {
